...
import { addTable3 } from "../features/transactions/table3Slice.js";

export default function TransactionForm3() {
  ...
  return (
    <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
      ...
      {/* Description */}
      <div>
        <label htmlFor="description3" style={labelStyle}>Description</label>
        <input
          id="description3"
          name="description"
          type="text"
      ...
      <div className="form-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
        ...
        <div>
          <label htmlFor="income3" style={labelStyle}>Income 💰</label>
        ...
        <div>
          <label htmlFor="outgoing3" style={labelStyle}>Expense 💸</label>
          <div style={{ position: "relative" }}>
            <span style={{
              position: "absolute",
              left: "12px",
