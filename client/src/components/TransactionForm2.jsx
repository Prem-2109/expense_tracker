...
import { addTable2 } from "../features/transactions/table2Slice.js";
...
export default function TransactionForm2() {
  ...
  return (
    <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
      ...
      {/* Description */}
      <div>
        <label htmlFor="description2" style={labelStyle}>Description</label>
        <input
          id="description2"
          name="description"
          type="text"
      ...
      <div className="form-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
        ...
        <div>
          <label htmlFor="income2" style={labelStyle}>Income 💰</label>
        ...
        <div>
          <label htmlFor="outgoing2" style={labelStyle}>Expense 💸</label>
          <div style={{ position: "relative" }}>
            <span style={{
              position: "absolute",
              left: "12px",
