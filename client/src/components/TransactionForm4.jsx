...
import { addTable4 } from "../features/transactions/table4Slice.js";

export default function TransactionForm4() {
  ...
  return (
    <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
      ...
      {/* Description */}
      <div>
        <label htmlFor="description4" style={labelStyle}>Description</label>
        <input
          id="description4"
          name="description"
          type="text"
      ...
      <div className="form-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
        ...
        <div>
          <label htmlFor="income4" style={labelStyle}>Income 💰</label>
        ...
        <div>
          <label htmlFor="outgoing4" style={labelStyle}>Expense 💸</label>
          <div style={{ position: "relative" }}>
            <span style={{
              position: "absolute",
              left: "12px",
