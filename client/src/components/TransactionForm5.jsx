...
import { addTable5 } from "../features/transactions/table5Slice.js";

export default function TransactionForm5() {
  ...
  return (
    <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
      ...
      {/* Description */}
      <div>
        <label htmlFor="description5" style={labelStyle}>Description</label>
        <input
          id="description5"
          name="description"
          type="text"
      ...
      <div className="form-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
        ...
        <div>
          <label htmlFor="income5" style={labelStyle}>Income 💰</label>
        ...
        <div>
          <label htmlFor="outgoing5" style={labelStyle}>Expense 💸</label>
          <div style={{ position: "relative" }}>
            <span style={{
              position: "absolute",
              left: "12px",
