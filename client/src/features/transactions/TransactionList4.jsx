...
export default function TransactionList4() {
  const dispatch = useDispatch();
  const { list } = useSelector((state) => state.table4);
  ...
  const handleDrop = (e, dropIndex) => {
    ...
    dispatch(reorderLocal4(updated));
  ...
  if (sortedList.length === 0) {
    return (
      <div className="empty-state">
        ...
        {showImportModal && (
          <ImportModal activeTab={4} onClose={() => setShowImportModal(false)} />
        )}
      </div>
    );
  }
                  ...
                  return (
                    ...
                    >
                      ...
                      <td style={{ background: "#FFFFAA", textAlign: "center" }}>
                        ...
                        <button className="et-delete-btn" onClick={() => dispatch(deleteTable4(tx._id))}>✕</button>
                      </td>
                    </tr>
                  );
                }
                      ...
                      <div style={{ display: "flex", gap: "6px", justifyContent: "center", alignItems: "center" }}>
                        {isEditing ? (
                          ...
                          <>
                            ...
                            <button className="et-delete-btn" onClick={() => dispatch(deleteTable4(tx._id))} title="Delete">✕</button>
                          </>
                        )}
                      </div>
                    </td>
